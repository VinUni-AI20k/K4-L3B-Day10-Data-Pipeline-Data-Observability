...
class SimplePaperAgent:
    """Agent fallback dam bao luon san sang phuc vu live demo va testset."""
    ...
    def invoke(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        ans = answer_question(question, settings=self.settings, index=self.index)
        return {"messages": [{"role": "assistant", "content": ans.answer}]}
