...
| **Mean Token F1** | `0.6676` | `0.4380` | `0.6676` |
| **Judge Accuracy** | `70.00%` | `40.00%` | `70.00%` |
| **Mean Judge Score** | `3.20` | `2.40` | `3.20` |

---
## 🔍 Observations & Findings

1. **Silent Failure Detection:** When synthetic data corruption occurred, the RAG Retrieval Hit Rate dropped to `100.00%`, proving that corrupted vectors silently degrade LLM answer quality.
